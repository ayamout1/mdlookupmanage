...
class ServiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Service::with(['vendors'])->select(sprintf('%s.*', (new Service())->table));
        ...
        return view('admin.services.index', compact('vendors'));
    }
    ...
    public function store(StoreServiceRequest $request)
    {
        ...
        $service->vendors()->sync($request->input('vendors', []));
