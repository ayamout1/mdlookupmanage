    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-vendorBrands">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($brands as $key => $brand)
                            <tr data-entry-id="{{ $brand->id }}">
                                ...
                                <td>
                                    @foreach($brand->vendors as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-vendorBrands:not(.ajaxTable)').DataTable({ buttons: dtButtons })
