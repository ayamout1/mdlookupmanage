    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-vendorAddresses">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.address.fields.vendor') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-vendorAddresses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
