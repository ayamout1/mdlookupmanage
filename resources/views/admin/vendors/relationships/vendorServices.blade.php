    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-vendorServices">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.service.fields.vendor') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($services as $key => $service)
                            <tr data-entry-id="{{ $service->id }}">
                                ...
                                <td>
                                    @foreach($service->vendors as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-vendorServices:not(.ajaxTable)').DataTable({ buttons: dtButtons })
