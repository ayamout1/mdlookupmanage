    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-vendorEngines">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($engines as $key => $engine)
                            <tr data-entry-id="{{ $engine->id }}">
                                ...
                                <td>
                                    @foreach($engine->vendors as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-vendorEngines:not(.ajaxTable)').DataTable({ buttons: dtButtons })
