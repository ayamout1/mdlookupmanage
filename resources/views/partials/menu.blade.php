    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.mainfilter.reportprelude") }}" class="nav-link ">
                        <i class="fa-fw nav-icon fas fa-server">

                        </i>
                        <p>
                            Missing Prelude Numbers
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route("admin.mainfilter.reportvendornumbers") }}" class="nav-link ">
                        <i class="fa-fw nav-icon fas fa-server">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.mainfilter.listvp") }}" class="nav-link ">
                        <i class="fa-fw nav-icon fas fa-server">
                ...
                @endcan
                @can('prelude_number_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.prelude-numbers.index") }}" class="nav-link {{ request()->is("admin/prelude-numbers") || request()->is("admin/prelude-numbers/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">
                ...
                @endcan
                @can('vendor_number_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.vendor-numbers.index") }}" class="nav-link {{ request()->is("admin/vendor-numbers") || request()->is("admin/vendor-numbers/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">
                ...
                @can('warranty_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.warranties.index") }}" class="nav-link {{ request()->is("admin/warranties") || request()->is("admin/warranties/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">
